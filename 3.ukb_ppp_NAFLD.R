...
# Read exposure list
iddf <- read.table("ukb.txt", header = TRUE, sep = "\t")
...
# Save final result
write.table(result, "ukb_ppp-finngen_R12_NAFLD-mr-all-results_FDR.txt", sep = "\t", quote = FALSE, row.names = FALSE)
